...
public class OrderController {
    ...
    private final CartRepository  cartItemRepository; // ← NEW

    // ── Constructor — added CartItemRepository ──
    public OrderController(OrderRepository orderRepository,
                           OrderItemRepository orderItemRepository,
                           ProductRepository productRepository,
                           UserRepository userRepository,
                           CartRepository cartItemRepository) { // ← NEW
        this.orderRepository     = orderRepository;
        this.orderItemRepository = orderItemRepository;
        this.productRepository   = productRepository;
        this.userRepository      = userRepository;
        this.cartItemRepository  = cartItemRepository; // ← NEW
    }
    ...
    public ResponseEntity<?> saveOrder(@RequestBody Map<String, Object> body,
        ...
        try {
            ...
            // ── Clear cart from DB after order placed ──
            cartItemRepository.deleteByUserId(user.getUser_id()); // ← NEW
